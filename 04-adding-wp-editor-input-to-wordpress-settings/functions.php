...
/**
 * Source code for forth post in the WordPress settings series.  
 * @link    https://timscheman.com/blog/adding-wp-editor-field-to-wordpress-settings/
...
function ltdi_register_settings()
{
    ...
    if (false == get_option('ltdi_theme_settings')) {
        $defaults = [
            ...
            'setting_wp_editor_field'   => '' /* Add new default */
        ];
    ...
    /**
     * New Code: adding the WP Editor field via the callback "ltdi_get_editor_input".
     */
    add_settings_field(
...
/**
 * New Code: "ltdi_get_editor_input" callback that builds the HTML for the WP Editor field.
 */
