...
/**
 * Source code for seventh post in the WordPress settings series.  
 * @link    https://timscheman.com/blog/adding-radio-buttons-to-wordpress-settings/
...
function ltdi_register_settings()
{
    ...
    if (false == get_option('ltdi_theme_settings')) {
        $defaults = [
            ...
            'setting_radio_button_field'    => 'value-01' /* Add new default */
        ];
